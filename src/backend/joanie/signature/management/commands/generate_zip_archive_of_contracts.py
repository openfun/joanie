...
class Command(BaseCommand):
    ...
    Then, it gets all signed Contracts from either an existing offering object UUID
    ...
    def add_arguments(self, parser):
        ...
        Product offering UUID, or an Organization UUID in order to get signed Contracts that are
        ...
        parser.add_argument(
            "-offering",
            "--offering_id",
            help=("Accept a single UUID of offering object."),
        )
