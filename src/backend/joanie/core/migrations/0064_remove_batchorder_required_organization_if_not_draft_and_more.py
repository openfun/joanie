...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='batchorder',
            constraint=models.CheckConstraint(check=models.Q(('state__in', ['draft', 'canceled']), ('organization__isnull', False), _connector='OR'), name='required_organization_if_not_draft_or_canceled', violation_error_message='BatchOrder requires organization unless in draft of cancel states.'),
        ),
    ]
