# Generated by Django 4.2.18 on 2025-03-07 13:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_declaration_number', models.CharField(help_text='company activity code number declared', max_length=255, verbose_name='activity declaration number')),
                ('address', models.CharField(help_text='company address', max_length=255, verbose_name='address')),
                ('post_code', models.CharField(help_text='company postcode', max_length=50, verbose_name='postcode')),
                ...
                ('trainees', models.JSONField(encoder=django.core.serializers.json.DjangoJSONEncoder, help_text='trainees name list', verbose_name='trainees')),
