...
class BatchOrderFlow:
    ...
    def _can_be_state_completed(self):
        ...
        When the payment method is with purchase order, we verify that the agreement
        is signed by the buyer, the purchase reference has been provided and that
        the related orders have been generated.
        """
