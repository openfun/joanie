...
ORDER_STATES_VOUCHER_CLAIMABLE = (*ORDER_INACTIVE_STATES, ORDER_STATE_TO_OWN)

ORDER_NATURE_B2C = "b2c"
ORDER_NATURE_B2B = "b2b"
# CPF: "Compte Personnel de Formation" (French personal training account)
ORDER_NATURE_CPF = "cpf"

ORDER_NATURE_CHOICES = (
    (ORDER_NATURE_B2C, _("B2C")),
    (ORDER_NATURE_B2B, _("B2B")),
    (ORDER_NATURE_CPF, _("CPF")),
)
...
PAYMENT_STATES_TO_PAY = PAYMENT_STATES_TO_DEBIT + (PAYMENT_STATE_REFUSED,)
...
BATCH_ORDER_STATE_CHOICES = (
    ...
    (BATCH_ORDER_STATE_PROCESS_PAYMENT, _("Process payment")),
