...
class BatchOrderAdminApiPartialUpdateTestCase(TestCase):
    ...
    def test_api_admin_batch_orders_partial_update_authenticated_admin(self):
        """
        Authenticated admin user should be able to partial update some fields
        of the batch order.
        """
        ...
        self.assertEqual(batch_order.company_name, "New company name")
        self.assertEqual(batch_order.address, "Street of awesomeness")
        self.assertEqual(batch_order.city, "Paris")
        self.assertEqual(batch_order.identification_number, "123456")

    def test_api_admin_batch_orders_partial_update_with_voucher_code(self):
        """
        Authenticated admin user should not be able to partial update the batch order with
    ...
    def test_api_admin_batch_orders_partial_update_trainees(self):
        """
        Authenticated admin user can partial update the trainees of the batch order
