...
class OfferingDeepLinkRetrieveAdminApiTestCase(BaseAPITestCase):
    ...
    def test_admin_api_offering_deeplink_retrieve_with_staff_user(self):
        """Authenticated lambda user should be able to retrieve the deeplink of an offering"""
    ...
    def test_admin_api_offering_deeplink_retrieve_superuser(self):
        ...
        self.assertDictEqual(
            {
                ...
                "is_active": True,
                "deep_link": offering_deeplink.deep_link,
                "offering": str(offering.id),
                "organization": str(organization.id),
            },
            response.json(),
