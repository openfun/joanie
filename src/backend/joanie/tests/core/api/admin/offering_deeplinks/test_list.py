...
class OfferingDeepLinkListAdminApiTestCase(BaseAPITestCase):
    ...
    def test_admin_api_offering_deeplink_list_anonymous(self):
        """Anonymous user should not be able to list the deeplinks of an offering"""
    ...
    def test_admin_api_offering_deeplink_list_with_lambda_user(self):
        """Authenticated lambda user should not be able to list the deeplinks of an offering"""
    ...
    def test_admin_api_offering_deeplink_list_with_staff_user(self):
        """Authenticated lambda user should be able to list the deeplinks of an offering"""
    ...
    def test_admin_api_offering_deeplink_list_superuser(self):
