...
class OrganizationApiContractSignatureLinkTest(BaseAPITestCase):
    ...
    def test_api_organization_contracts_from_batch_order_signature_link_without_owner(self):
        """
        Authenticated users which is not an organization owner should not be able
        to sign contracts in bulk.
        """
    ...
    def test_api_organization_contracts_from_batch_order_with_offering_id(self):
        """
    ...
    def test_api_organization_contracts_from_batch_order_with_contract_ids(self):
        """
        Authenticated user with the owner role should be able to sign the contracts in
