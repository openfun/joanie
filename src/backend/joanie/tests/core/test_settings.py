...
from joanie.settings import get_release
...
class GetReleaseTestCase(TestCase):
    ...
    def test_settings_get_release_returns_default_without_version_file(self, *args):
        """
    ...
    def test_settings_get_release_from_a_valid_version_file(self, *args):
        """
        Get release from the version.json file that is supposed to exist (and
    ...
    def test_settings_get_release_from_an_invalid_version_file(self, *args):
        """
        Get release from the version.json file that is supposed to exist (and
