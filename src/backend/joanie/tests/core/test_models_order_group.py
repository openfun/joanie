...
class OrderGroupModelTestCase(TestCase):
    ...
    def test_model_order_group_find_assignables_none(self):
        """
        Should return None if no order group is found for the given course and product.
        """
        relation = factories.CourseProductRelationFactory()

        assignable_order_groups = OrderGroup.objects.find_assignables(relation.id)

        self.assertQuerysetEqual(assignable_order_groups, [])

    def test_model_order_group_find_assignables(self):
        """
    ...
    def test_model_order_group_find_assignables_position(self):
        """
        Should return the order group linked to the given course and product
        ordered by position.
        """
    ...
    def test_model_order_group_find_assignables_last_matching(self):
        """
