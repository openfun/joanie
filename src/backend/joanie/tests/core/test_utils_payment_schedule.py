...
class PaymentScheduleUtilsTestCase(TestCase, BaseLogMixinTestCase):
    ...
    def test_utils_payment_schedule_retraction_date(self):
        """
        ...
        self.assertEqual(
            _retraction_date(start_date),
            datetime(2024, 1, 17, 0, 0, tzinfo=ZoneInfo("UTC")),
        )

    def test_utils_payment_schedule_retraction_date_weekend(self):
        """
    ...
    def test_utils_payment_schedule_retraction_date_new_year_eve(self):
        """
