...
from joanie.tests.base import EventMixingTestCase
...
class BasePaymentBackendTestCase(BasePaymentTestCase, EventMixingTestCase):
    ...
    def test_payment_backend_base_do_on_payment_failure(self):
        ...
        # - An event has been created
        self.assertPaymentFailedEvent(order)
