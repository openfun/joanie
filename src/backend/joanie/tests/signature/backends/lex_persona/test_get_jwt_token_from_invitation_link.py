"""Test suite for the Lex Persona Signature Backend get_jwt_token_from_invitation_link"""
...
class LexPersonaBackendGetJwtTokenFromInvitationLinkTestCase(TestCase):
    """Test suite for Lex Persona Signature provider Backend get_jwt_token_from_invitation_link."""
