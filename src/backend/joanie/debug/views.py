...
class DebugWithdrawal(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        with translation.override(current_language):
            product_title = product.safe_translation_getter(
...
class DebugWithdrawalRejectionViewHtml(DebugWithdrawal):
...
class DebugWithdrawalRejectionViewTxt(DebugWithdrawal):
