...
export const commonTranslations = defineMessages({
  title: {
    id: "translations.common.commonTranslations.title",
  ...
  upload: {
    id: "translations.common.commonTranslations.upload",
    defaultMessage: "Upload",
    description: "Common upload label",
  },
  edit: {
  ...
  create: {
    id: "translations.common.commonTranslations.create",
    defaultMessage: "Create",
    description: "Common create label",
  },
  view: {
