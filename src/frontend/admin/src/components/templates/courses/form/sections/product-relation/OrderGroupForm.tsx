...
const messages = defineMessages({
  ...
  startLabel: {
    id: "components.templates.products.form.sections.OderGroups.OrderGroupForm.startLabel",
    defaultMessage: "Start date",
    description: "The input label for the start date",
  },
  endLabel: {
    id: "components.templates.products.form.sections.OderGroups.OrderGroupForm.endLabel",
