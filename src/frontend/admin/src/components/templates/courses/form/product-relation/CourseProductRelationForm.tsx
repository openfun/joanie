    ...
    >
      <Grid container spacing={2}>
        ...
        <Grid xs={12}>
          ...
          {/*  selectedOptions={organizationArray.fields as Organization[]} */}
          {/*  getOptionLabel={(option) => option.title} */}
          {/*  isOptionEqualToValue={(option, value) => */}
          {/*    option.title === value.title */}
          {/*  } */}
          {/*  getOptionDisabled={(option: Organization) => { */}
          {/*    const index = organizationArray.fields.findIndex((org) => { */}
          {/*      return option.title === org.title; */}
          {/*    }); */}
          {/*    return index > 0; */}
          {/*  }} */}
