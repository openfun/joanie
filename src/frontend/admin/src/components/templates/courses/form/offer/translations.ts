...
export const courseProductRelationFormMessages = defineMessages({
  productTitle: {
    id: "components.templates.course.form.productRelation.translations.productTitle",
    defaultMessage: "Product",
    description: "Label for the main information subheader form",
  },
  codeLabel: {
    id: "components.templates.course.form.translations.codeLabel",
    defaultMessage: "Code",
