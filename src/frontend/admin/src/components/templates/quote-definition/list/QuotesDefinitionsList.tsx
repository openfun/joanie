...
const messages = defineMessages({
  languageHeader: {
    id: "components.templates.quotesDefinitions.list.languageHeader",
    defaultMessage: "Language",
    description: "Label for the language header inside the table  ",
  },
  titleHeader: {
    id: "components.templates.quotesDefinitions.list.titleHeader",
...
export function QuotesDefinitionsList(props: Props) {
  const intl = useIntl();
