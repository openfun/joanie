          ...
          <Grid container spacing={2}>
            ...
            <Grid xs={12}>
              <TextField
                ...
                value={enrollment.user.full_name ?? enrollment.user.email}
              />
            </Grid>
            <Grid xs={12}>
              <TextField
            ...
            <Grid xs={12} sm={6}>
              <FormControlLabel
                color="primary"
                control={<Checkbox checked={enrollment.was_created_by_order} />}
            ...
            <Grid xs={12} sm={6}>
              <FormControlLabel
                color="primary"
                control={<Checkbox checked={enrollment.is_active} />}
